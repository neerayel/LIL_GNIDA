#!/usr/bin/env python3
"""
Основной модуль запуска Telegram бота для управления сервером компании.
Главный файл, который инициализирует и запускает бота.
"""
...
from handlers import start, button_click_handler
